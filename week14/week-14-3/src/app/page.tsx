...
// this is server side rendering
  ...
  import axios from "axios";
import {getData } from "@/app/actions/user"
...
const responce:any = await getData("harkirate@gmail.com","2323232323")

return responce
}
export default async function Home() {
  // const data :any = await GetData()
  const data = await getData("harkirate@gmail.com","2323232323")
